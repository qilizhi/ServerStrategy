 ...
 * 
 */
package com.dz.base.repository.base;
...
public abstract class BeanUtils extends org.springframework.beans.BeanUtils {
	...
	public static void copyPropertiesIgnoreEmpty(Object source, Object target) throws BeansException {
		copyPropertiesIgnoreEmpty(source, target, null, (String[]) null);
	}
	/**
	...
	public static void copyPropertiesIgnoreEmpty(Object source, Object target, Class<?> editable) throws BeansException {
		copyPropertiesIgnoreEmpty(source, target, editable, (String[]) null);
	}
	private static void copyPropertiesIgnoreEmpty(Object source, Object target, Class<?> editable,
		...
		for (PropertyDescriptor targetPd : targetPds) {
			...
			if (writeMethod != null && (ignoreList == null || !ignoreList.contains(targetPd.getName()))) {
				...
				if (sourcePd != null) {
					...
					Method readMethodT=targetPd.getReadMethod();
					if (readMethod != null && ClassUtils.isAssignable(writeMethod.getParameterTypes()[0],
						...
						try {
							...
							Object valueT=readMethodT.invoke(target);
							...
							if (value != null&&!"".equals(value)){
								if(!ClassUtils.isPrimitiveOrWrapper(value.getClass())&&(!value.getClass().equals(String.class))&&ClassUtils.isAssignable(readMethod.getReturnType(),readMethodT.getReturnType())){
									//递归copy
									if(valueT==null){
										valueT=readMethodT.getReturnType().newInstance(); 
									}
									copyPropertiesIgnoreEmpty(value,valueT);
									writeMethod.invoke(target, valueT);
								}else{
